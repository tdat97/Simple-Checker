...
def glance(target_path, key_path):
    ...
    if os.path.isfile(key_path):
        ...
        # decrypt
        # key_str = decrypt(enc_key_str, enc_target_str)
        # target_str = decrypt(enc_target_str, key_str)
    ...
    # enc_target_str = encrypt(target_str, key_str)
    # enc_key_str = encrypt(key_str, enc_target_str)
    for _ in range(REPEAT_NUM):
